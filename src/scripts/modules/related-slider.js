...
export default () => {
	...
	const sliderContainers = document.querySelectorAll( '.js-cc-related-slider' );
		...
		const initSlider = (sliderContainer, index) => {
			const parent     = sliderContainer.parentNode;
				...
				sliders[ index ] = new Swiper( sliderContainer, {
					...
					navigation: {
						prevEl: parent.querySelector( '.js-cc-related-prev' ),
						nextEl: parent.querySelector( '.js-cc-related-next' ),
					},
					pagination: {
						el: parent.querySelector( '.js-cc-related-pagination' ) || null,
						clickable: true,
